...
vim.keymap.set("n", "<leader>wx", ":close<CR>", { desc = "Kill window" })
vim.keymap.set("n", "<leader>wX", ":close!<CR>", { desc = "Force kill window" })
vim.keymap.set("n", "<C-.>", ":resize +5<CR>", { desc = "Increase window size" })
vim.keymap.set("n", "<C-,>", ":resize -5<CR>", { desc = "Decrease window size" })
vim.keymap.set("n", "<leader><", "<c-w>5<", { desc = "Increase window size right" })
vim.keymap.set("n", "<leader>>", "<c-w>5>", { desc = "Decrease window size left" })
